  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-24">
     <div className="w-130 relative right-90">
      ...
      <p className="text-xl  text-neutral-100">I’m Rashmika, a passionate and dedicated software engineering student with a deep interest in UI/UX design. My journey in the world of technology started with a curiosity for problem-solving and a fascination with how digital tools can improve user experiences.
