...
const project = [
  ...
  },
  {
    ...
    description:
      "This project was done for my react project in campus as a final project",
    tags: ["React", "JavaScript", "tailwindCSS"],
    image: smsimg,
...
const Main = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12 text-white tracking-wide">
      ...
      >
        <h1 className="font-bold text-[2.25rem] sm:text-[3.5rem] lg:text-[5rem] tracking-wide">
          Designer
        </h1>

        <p className="text-lg text-neutral-600 max-w-4xl">
          UI-focused product designer with expertise in creating design systems
          and crafting intuitive, user-friendly interfaces that enhance overall
          user experiences.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-lg text-neutral-500 max-w-4xl">
          Frontend and Backend developer who writes clean, elegant, and
          efficient code.
        </p>
      </motion.div>
      ...
      >
        <p className="text-xl text-neutral-700 max-w-3xl mx-auto">
          Hello, I'm <span className="text-6xl font-bold">Rashmika</span>, a
          software engineering student with a strong passion for UI/UX design. I
          create user-friendly and visually appealing interfaces, focusing on
      ...
      <Link
        to="/about"
        className="mt-6 animate-bounce absolute bottom-27 left-288"
      >
        <svg
          className="size-9"
          xmlns="http://www.w3.org/2000/svg"
