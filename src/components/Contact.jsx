...
const Contact = () => {
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-24">
       <motion.div
  className="w-100 relative right-110"
...
>
  ...
  <div>
    <SocialButtons />
        ...
        <motion.p
  className="text-xl text-neutral-700 max-w-3xl mx-auto relative left-130 bottom-50 w-80"
...
>
  ...
  </span>, a software engineering student with a strong passion for UI/UX design. I create user-friendly and visually appealing interfaces, focusing on delivering seamless experiences.
</motion.p>
